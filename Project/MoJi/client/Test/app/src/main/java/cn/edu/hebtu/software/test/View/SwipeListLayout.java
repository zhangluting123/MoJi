package cn.edu.hebtu.software.test.View;
 ...
 * @author 春波
 * @ProjectName Test
 * @PackageName：cn.edu.hebtu.software.test.CustomLayout
 * @Description：
 * @time 2019/12/14 19:25
 */
public class SwipeListLayout extends FrameLayout {
    ...
    /**
     *  @author 春波
     *  @time 2019/12/14  20:55
     *  @Description：ViewDragHelper的回调
     */
