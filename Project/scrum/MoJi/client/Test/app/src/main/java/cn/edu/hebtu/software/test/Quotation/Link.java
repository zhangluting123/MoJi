...
public class Link {
        ...
        new Thread() {
            ...
            public void run() {
                try{
                    ...
                    URL url = new URL("http://192.168.137.1:8080/MoJi/Servlet?infot="+"6"+"&infoc="+command+"&infod="+toServerData);
    ...
    private void wrapperMessage(String info) {
        ...
        for(int i=0;i<splitAll.length;i++) {
            ...
            DataBean dataBean = new DataBean(Integer.parseInt(splitLine[0]), splitLine[1], splitLine[2], splitLine[3], "",splitLine[5]);
            list.add(dataBean);
        }
